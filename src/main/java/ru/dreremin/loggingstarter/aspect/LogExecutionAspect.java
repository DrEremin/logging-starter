package ru.dreremin.loggingstarter.aspect;
...
import ru.dreremin.loggingstarter.annotation.LogExecutionTime;
...
public class LogExecutionAspect {
    ...
    @Around("@annotation(ru.dreremin.loggingstarter.annotation.LogExecutionTime)")
